...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <?php
        echo '<h1>Entregas:<b>' . $tarea["nombre"] . '</b></h1>
      <h2>Fecha Limite:<b>' . $tarea["fecha_limite"] . '</b></h2>
      <a href="http://localhost/Aulas/Reportes/'. $exp[1] . '"><button class="btn btn-danger">Reporte pdf</button></a>
      <a href="http://localhost/Aulas/ReportesExcel/'. $exp[1] . '"><button class="btn btn-success">Generar excel</a>
                ...
                <table class="table table-hover table-striped table-bordered dt--responsive">
                    ...
                    <tbody>
                        ...
                        foreach ($resultado as $key => $value) {
                            ...
                            <td><a href="http://localhost/Aulas/' . $value["tarea_alumno"] . '" download="' . $alumno["apellido"] . '">Descargar</a></td>
                            <td><a href="http://localhost/Aulas/' . $value["tarea_alumno"] . '" target="_blank">ver archivo</a></td>';
                            ...
                            foreach ($notas as $key => $nota) {
                                if ($nota["id_entrega"] == $value["id"]) {
                                    ...
                                    <form method="post">
                                         <div class="col-md-2">
                                              Nota:<input type="text" name="nota" style="width:100%" required pattern="[0-9]*\.?[0-9]*" value="' . $nota["nota"] . '">
                                         ...
                                         <div class="col-md-4">
                                              Estado:<select required name="estado" style="width:100%">
